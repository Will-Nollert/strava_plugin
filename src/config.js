...
const CONFIG = {
  ...
  AUTH_PROXY_URL: process.env.AUTH_PROXY_URL || "https://YOUR_API_GATEWAY_URL.execute-api.YOUR_REGION.amazonaws.com/prod",
    
  // Client ID can be included in the frontend code as it's a public identifier
  STRAVA_CLIENT_ID: process.env.STRAVA_CLIENT_ID,
    
  // OAuth configuration
  REDIRECT_URL: chrome.identity ? chrome.identity.getRedirectURL() : "urn:ietf:wg:oauth:2.0:oob",
